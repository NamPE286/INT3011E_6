...
>
	{#snippet children({ thumbItems })}
		<span
			...
			class={cn(
				"bg-input/90 rounded-full data-horizontal:h-2 data-horizontal:w-full data-vertical:h-full data-vertical:w-2 relative grow overflow-hidden data-horizontal:w-full data-vertical:h-full"
			)}
		>
